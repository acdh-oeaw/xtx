...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.tei-c.org/ns/1.0" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="#all" version="2.0">
    ...
    <xsl:template match="tei:text">
        <xsl:copy>
            ...
            <body>
                <ab>
                    <xsl:apply-templates select="." mode="extractTokens"/>
                </ab>
            </body>
        </xsl:copy>
    </xsl:template>
